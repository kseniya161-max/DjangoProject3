...
class User(AbstractUser):
    ...
    username = models.CharField(max_length=50,  unique=True, verbose_name= 'имя пользователя',blank=True, null=True, help_text='Введите имя пользователя')
    email = models.EmailField(max_length=50, verbose_name='Email', help_text='Введите email')
